...
class DsrTcpAppBasicTestCase : public TestCase
{
public:
  DsrTcpAppBasicTestCase ();
  virtual ~DsrTcpAppBasicTestCase ();
...
DsrTcpAppBasicTestCase::DsrTcpAppBasicTestCase ()
...
void
DsrTcpAppBasicTestCase::SendTx (Ptr<const Packet> p)
{
  m_sent += p->GetSize ();
}

void
DsrTcpAppBasicTestCase::ReceiveRx (Ptr<const Packet> p, const Address& addr) 
{
  m_received += p->GetSize ();
}

void
DsrTcpAppBasicTestCase::DoRun (void)
{
  ...
  source->TraceConnectWithoutContext ("Tx", MakeCallback (&DsrTcpAppBasicTestCase::SendTx, this));
  sink->TraceConnectWithoutContext ("Rx", MakeCallback (&DsrTcpAppBasicTestCase::ReceiveRx, this));
...
{
  AddTestCase (new DsrTcpAppBasicTestCase, TestCase::QUICK);
