...
#ifndef DSR_TCP_APPLICATION_HELPER_H
#define DSR_TCP_APPLICATION_HELPER_H
 ...
 * on a set of nodes.
 */
class DsrTcpAppHelper
{
public:
  /**
   * Create an DsrTcpAppHelper to make it easier to work with BulkSendApplications
   *
   ...
   *        to.
   */
  DsrTcpAppHelper (std::string protocol, Address address);
