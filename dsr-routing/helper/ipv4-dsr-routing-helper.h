 ...
 */
#ifndef IPV4_DSR_ROUTING_HELPER_H
#define IPV4_DSR_ROUTING_HELPER_H
 ...
 */
class Ipv4DSRRoutingHelper  : public Ipv4RoutingHelper
{
public:
  /**
   ...
   */
  Ipv4DSRRoutingHelper (const Ipv4DSRRoutingHelper &);
...
private:
   ...
   * \return
   */
  Ipv4DSRRoutingHelper &operator = (const Ipv4DSRRoutingHelper &);
};
