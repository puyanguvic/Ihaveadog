...
#include "ns3/dsr-virtual-queue-disc.h"
...
main (int argc, char *argv[])
{
  ...
  Ptr<QueueDisc> q = tc->GetRootQueueDiscOnDevice (devices.Get(0));
  // Ptr<QueueDisc> q = qdiscs.Get (1);
  std::cout << "----------------------------" << q->GetInternalQueue (0)->GetMaxSize ().GetValue ()<< std::endl;
