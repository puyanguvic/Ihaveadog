...
#ifndef DSR_ROUTE_MANAGER_H
#define DSR_ROUTE_MANAGER_H
 ...
 *
 */
  static void DeleteDSRRoutes ();

/**
 * @brief Build the routing database by gathering Link State Advertisements
 * from each node exporting a DSRRouter interface.
 */
  static void BuildDSRRoutingDatabase ();
 ...
 */
  DSRRouteManager (DSRRouteManager& srm);
 ...
 */
  DSRRouteManager& operator= (DSRRouteManager& srm);
};

} // namespace ns3

#endif /* DSR_ROUTE_MANAGER_H */
